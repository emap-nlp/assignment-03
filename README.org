#+title: Assignment 03 - Introdução a NLP
...
* Introdução
  ...
  UDPipe 1.2, por ser mais fácil de instalar e treinar (vide a
  seguir).
...
* DHBB
  ...
  O [[https://cpdoc.fgv.br/acervo/dhbb][DHBB]] é uma especia de enciclópedia do CPDOC com textos sobre a
...
* Tarefa
  ...
  3. Corrigir os casos mais frequentes e inconsistentes e acrescentar
     as sentenças corrigidas ao corpus Bosque criando um Bosque+DHBB.
  ...
  fazer alguma coisa com o próximo nó lido. Esta é uma solução boa,
  mas muito particular para a tarefa.

  Uma alternativa seria converter a árvore para algum formato que
  possa ser consultado por uma linguagem de consulta. Por exemplo,
  você pode transformar os dados em [[https://www.w3.org/TR/rdf-primer/][RDF]] (usando
  ...
  poderiam então ser consultados usando [[https://www.w3.org/TR/sparql11-query/][SPARQL]].

  Ou você poderia usar Prolo se a partir das árvores você produzir um
...
* Exemplo
  ...
  O formato YAML é facilmente lido em várias linguagens. Em Haskell,
